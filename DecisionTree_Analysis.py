...
# Tree complexity information
total_nodes = classifier.tree_.node_count
num_splits = sum(classifier.tree_.children_left[i] != classifier.tree_.children_right[i] for i in range(total_nodes))

print("Total nodes in the decision tree:", total_nodes)
